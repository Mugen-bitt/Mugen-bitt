...
Совмещаю ручное тестирование с автоматизацией на Java стеке.
Участвую в настройке CI/CD и интеграции автотестов, что помогает стабилизировать регрессию и ускорить релизы.
